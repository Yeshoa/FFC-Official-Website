---
title: "The first Forest Cup"
date: 2024-07-24
author: "Bolbon"
tags: [history, forest-cup, bilsa]
summary: "A look back at the first Forest Cup Bilsa 2020."
image: "/src/assets/images/articles/fc-2020/waving-flag.png"
---

import { Image } from 'astro:assets';
import EggTrigger from '@components/easter-eggs/EggTrigger.astro';
...
import EggBilsa from '@images/eggs/egg-bil.webp';
...
<div className="inline-block mt-2 absolute -translate-y-12 translate-x-12">
  <EggTrigger
    eggId="egg-4"
    image={EggBilsa}
    alt="Hidden Easter egg in the Forest Cup 2020 article"
    ariaLabel="Open article Easter egg"
    buttonClass="opacity-90 transition duration-300 hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-green-300"
    imageClass="w-10 rotate-[8deg]"
  />
</div>
