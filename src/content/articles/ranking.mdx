...
> Starting with Forest Cup 2026, the **top 24** ranked teams **(<a href={NEW_MEMBERS_FORM_LINK} target="_noblank">who have submitted their current form <Arrow class="inline w-3 h-3 fill-green-400 ml-1" /></a>)** qualify **directly**.  
...
**Flag & Banner (FB)**: Points from <a href="https://www.nationstates.net/page=rmb/postid=60040670" target="_blank" class="text-blue-300 hover:text-blue-200">Flag & Banner Contest <Arrow class="inline w-3 h-3 fill-green-400 ml-1" /></a>.
...
- Football Roleplay (0-40 points possible)
...
|------|-|-------------|
| <span class={`${getPointsTextColorClass(TIERS["X"])} font-bold`}>X</span> |**{TIERS["X"]}**| Legendary status reserved for the most dedicated members |
...
| <span class={`${getPointsTextColorClass(TIERS["S"])} font-bold`}>S</span> |**{TIERS["S"]}**| Pillars with exceptional long-term involvement |
| <span class={`${getPointsTextColorClass(TIERS["A"])} font-bold`}>A</span> |**{TIERS["A"]}**| Highly engaged members with substantial participation |
| <span class={`${getPointsTextColorClass(TIERS["B"])} font-bold`}>B</span> |**{TIERS["B"]}**| Strong contributors with consistent involvement |
| <span class={`${getPointsTextColorClass(TIERS["C"])} font-bold`}>C</span> |**{TIERS["C"]}**| Active participants in multiple categories |
| <span class={`${getPointsTextColorClass(TIERS["D"])} font-bold`}>D</span> |**{TIERS["D"]}**| Regular members with some engagement |
| <span class={`${getPointsTextColorClass(TIERS["E"])} font-bold`}>E</span> |**{TIERS["E"]}**| Basic participation, occasional roleplay |
| <span class={`${getPointsTextColorClass(TIERS["F"])} font-bold`}>F</span> |**{TIERS["F"]}**| New participants, minimal involvement |
...
**Rembemer**: Points earned in the current edition will only be applied if the participant submits the <a href={NEW_MEMBERS_FORM_LINK} target="_noblank">form for this season <Arrow class="inline w-3 h-3 fill-green-400 ml-1" /></a>.
