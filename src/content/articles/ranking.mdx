...
> Starting with Forest Cup 2026, the **top 24** ranked teams **(<a href={LINKS.forms.newMember} target="_noblank">who have submitted their current form <Arrow class="inline w-3 h-3 fill-green-400 ml-1" /></a>)** qualify **directly**.  
...
| <span class={`${getPointsTextColorClass(TIERS["S"])} font-bold`}>S</span> |**{TIERS["S"]}**| Pillars with exceptional long-term involvement | Argentina
